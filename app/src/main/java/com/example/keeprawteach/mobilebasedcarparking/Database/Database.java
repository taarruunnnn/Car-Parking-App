package com.example.keeprawteach.mobilebasedcarparking.Database;
...
public class Database extends SQLiteOpenHelper {
    ...
    // User table name
    private static final String TABLE_CALLBACK = "callback";
    // User Table Columns names
    private static final String COLUMN_CALLBACK_ID = "id";
    private static final String COLUMN_CALLBACK_NUMBER = "callback_number";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + TABLE_CALLBACK + "(" +
                "id INTEGER PRIMARY KEY AUTOINCREMENT," +
                "callback_number TEXT)");


        String ip = "192.168.42.63";
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_CALLBACK);
    ...
    public Cursor checkCallback(String id) {

        SQLiteDatabase db = this.getWritableDatabase();

        Cursor res = db.rawQuery("SELECT * FROM callback WHERE id=" + id + "", null);
