...
import com.example.keeprawteach.mobilebasedcarparking.ViewSlots.ViewSlots;
...
public class Search extends Fragment  {
    ...
    public class DownloadBookings extends AsyncTask<Void, Void, String> {
        ...
        protected class GetConnected {
            ...
            String sign_url = new Ip(context).location();
        ...
        private class AdapterClass extends BaseAdapter {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                if (viewHolder == null) {
                    convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.modelbookings, null);
